...
class SampleSpec:
    ...
    def to_manifest_row(self) -> dict[str, Any]:
        ...
        # Always include these keys, regardless of family, so every
        # manifest row has an identical, fixed schema. None (empty in
        # CSV, NaN in pandas) correctly signals "not applicable to this
        # family" and is expected/handled downstream (see fem_dataset.py).
