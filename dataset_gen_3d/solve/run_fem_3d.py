...
def _run_solve_fenicsx(
    ...
    # Interpolate CG2 solution to vertex-ordered CG1 for node arrays
    V_cg1 = fem.functionspace(msh, ("Lagrange", 1, (3,)))
    u_cg1 = fem.Function(V_cg1)
    u_cg1.interpolate(u_sol)
    u_array = u_cg1.x.array.reshape(n_nodes, 3).copy()
    ...
    cell_conn = elements_tet4 if elements_tet4 is not None else _get_mesh_connectivity(msh)
